...
class FusionConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, dilation=1, groups=1, padding='same', bias=False, bn=True, relu=False):
        super(FusionConv2d, self).__init__()
...
class SelfAttention(nn.Module):
    def __init__(self, in_channels, mode='hw', stage_size=None):
        ...
        self.query_conv = FusionConv2d(in_channels, in_channels // 8, kernel_size=(1, 1))
        self.key_conv = FusionConv2d(in_channels, in_channels // 8, kernel_size=(1, 1))
        self.value_conv = FusionConv2d(in_channels, in_channels, kernel_size=(1, 1))

...
class PAA_d(nn.Module):
    def __init__(self, in_channel, out_channel=1, depth=64, base_size=None, stage=None):
        ...
        self.conv1 = FusionConv2d(in_channel, depth, 3)
        self.conv2 = FusionConv2d(depth, depth, 3)
        self.conv3 = FusionConv2d(depth, depth, 3)
        self.conv4 = FusionConv2d(depth, depth, 3)
        self.conv5 = FusionConv2d(depth, out_channel, 3, bn=False)

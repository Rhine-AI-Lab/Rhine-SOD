...
class PAA_kernel(nn.Module):
    def __init__(self, in_channel, out_channel, receptive_size, stage_size=None):
        ...
        self.conv0 = FusionConv2d(in_channel, out_channel, 1)
        self.conv1 = FusionConv2d(out_channel, out_channel, kernel_size=(1, receptive_size))
        self.conv2 = FusionConv2d(out_channel, out_channel, kernel_size=(receptive_size, 1))
        self.conv3 = FusionConv2d(out_channel, out_channel, 3, dilation=receptive_size)
...
class PAA_e(nn.Module):
    def __init__(self, in_channel, out_channel, base_size=None, stage=None):
        ...
        self.branch0 = FusionConv2d(in_channel, out_channel, 1)
        ...
        self.conv_cat = FusionConv2d(4 * out_channel, out_channel, 3)
        self.conv_res = FusionConv2d(in_channel, out_channel, 1)
